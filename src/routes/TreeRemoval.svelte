<script>
  ...
  import cutupTree from "../assets/cutup-tree.jpg";
...
<svelte:head>
  <title>Tree Removal | JS Land Improvement</title>
</svelte:head>
...
<section class="applications-section">
  <div class="services-header">
    <div class="service-header-action">
      <h1>Tree Service</h1>
      <a class="quote-button" href="/contact-us" use:link>Free Quote</a>
    </div>
    <img src="{cutupTree}" alt="cutupTree" class="services-img" />
  </div>

  <div class="applications-text-container">
    <h3 class="applications">Applications</h3>
  </div>
  <div class="application-cards-container">
    {#each applications as application}
      <div class="card card-app-text">
        <p>
          {application}
        </p>
      </div>
...
<section class="more-info-service-section">
  <div class="more-info-header-and-para">
    <h3>Tree Service</h3>
    <div class="more-info-service-para-container">
      <span class="svg">
        <svg
      ...
      <p>
        Maintaining and removing trees is a dangerous yet important task to do
  ...
  <img src="{treeRemoval}" alt="treeRemoval" class="more-info-image" />
</section>
